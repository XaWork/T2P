...
class CustomRepository(baseUrl: String, consumerKey: String, consumerSecret: String) :
    ...
    fun saveAddress(userId:String, name:String, phone:String, city:String,state:String, pincode:String, postOffice:String, addressLine:String, secondary:String, lat:Double, lng:Double, type:String): Call<CommonResponse> {
        return apiService.saveAddress(userId, name, phone, city, state, pincode, postOffice, addressLine, secondary, lat, lng, type)
    }

    fun editAddress(addressId:String, name:String, phone:String, city:String,state:String, pincode:String, postOffice:String, addressLine:String, secondary:String, lat:Double, lng:Double, type:String): Call<CommonResponse> {
        return apiService.editAddress(addressId, name, phone, city, state, pincode, postOffice, addressLine, secondary, lat, lng, type)
    }
