...
class CategoryViewHolder(val context: Context, itemView: View) :
    ...
    fun renderView(
        ...
        val cateImage = itemView.findViewById<ImageView>(R.id.categoryImg)
        ...
        cateImage.setOnClickListener{
            Log.e("subcategory", "category image clicked ")

            //Toast.makeText(context, "category image clicked", Toast.LENGTH_SHORT).show()
