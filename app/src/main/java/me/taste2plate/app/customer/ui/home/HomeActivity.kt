...
import me.taste2plate.app.models.cutoff.isCutOffTimePassed
import me.taste2plate.app.models.newproducts.ShowError
import me.taste2plate.app.models.settings.Popup
                ...
                when (it.status()) {
                    ...
                    Status.SUCCESS -> {
                        ...
                        val shareBody = buildString {
                            ...
                            append("Register with Refer code: ${AppUtils(this@HomeActivity).user.mobile}\n" +
